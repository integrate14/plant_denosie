...
print('='*60)
print('Training IterativePFN - Debug Version')
print('='*60)
...
for epoch in range(num_epochs):
    ...
    for noisy, clean in train_loader:
        ...
        # 关键：使用 noisy 而不是 cleaned
        cleaned = model(noisy)

        # 方式1: 把 noisy 传给 get_loss (原始方式)
    ...
    if val_loss < best_val_loss:
        ...
        torch.save({
            ...
            'val_loss': val_loss,
        }, os.path.join(CHECKPOINT_DIR, 'IterativePFN_best_debug.pth'))
...
with torch.no_grad():
    for noisy, clean in val_loader:
        ...
        print(f'  CD: {cd.item():.6f}, P2P: {p2p.item():.6f}')
        break
